...
echo 15 | gmx pdb2gmx -ignh -f Protein.pdb -o Protein_processed.gro -water spce
...
gmx g_energy -f em.edr -o potential.xvg <<END
10
...
gmx mdrun -nt 24 -deffnm npt |& tee npt.out
...
gmx mdrun -nt 24 -deffnm md_0-10ns
