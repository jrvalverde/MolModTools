...
export acpype=`which acpype`		# get it from https://github.com/alanwilter/acpype
# analysis
...
while true ; do
	case "$1" in
		...
		-b|--box)
                    ...
                    # check $3 is a positive real number
                    if [[ $3 =~ ^[0-9]+(.[0-9]?)?$ ]] ; then
                        ybox=$3
                    else
                        echo ""
                        echo "ERROR: $3 is not a positive real number."
                        usage ; exit 1
                    fi
                    # check $4 is a positive real number
                    if [[ $4 =~ ^[0-9]+(.[0-9]?)?$ ]] ; then
                        ybox=$4
                    else
                        echo ""
                        echo "ERROR: $4 is not a positive real number."
                        usage ; exit 1
                    fi
