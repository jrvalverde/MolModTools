...
#
# NAME
#	gmx_extend_trj_ps - extend a trajectory by time in ps to new files
#
# SYNOPSIS
#	gmx_extend_trj_ps [name] [delta_ps]
#
# DESCRIPTION
...
# the specified delta time in picoseconds.
#
...
#	delta_ps	- the delta time in ps to add to the previous trajectory
#
# LICENSE:
#
...
GMX_EXTEND_TRJ_PS_H="GMX_EXTEND_TRJ_PS_H"
...
function gmx_extend_trj_ps() {
    ...
    gmx convert-tpr -s "$previous.tpr" -extend $timetoextendby -o "$next.tpr" -v
